...
namespace AZERP.Web.Modules.Recruitment.CompanyInfo
{
    ...
    public class FormCompanyInfo : ManageModule<CompanyInfoService, CompanyInfoModel, FormUpdateCompanyInfo>
    {
        #region -- Field Search --
        /// <summary>
        /// Họ Tên
        ...
        /// </summary>
        [QuerySearch]
        public string AspirationsOfCompanyInfos { get; set; }
        /// <summary>
        ...
        /// </summary>
        [QuerySearch]
        public PartnerType? TypeOfCompanyInfo { get; set; }
        /// <summary>
        /// Trạng thái cuộc gọi
        /// </summary>
        [QuerySearch]
        ...
        public FormCompanyInfo(IHttpContextAccessor httpContext) : base(httpContext)
        {
        }
        protected override void IntData()
        {
            this.Title = "Quản lý cộng tác viên";
        }
