...
namespace AZERP.Web.Modules.Recruitment.Collaborator
{
    ...
    public class FormCollaborator : ManageModule<CollaboratorService, CollaboratorModel, FormUpdateCollaborator>
    {
        ...
        /// </summary>
        [QuerySearch]
        public string AspirationsOfCollaborators { get; set; }
        /// <summary>
        ...
        /// </summary>
        [QuerySearch]
        public PartnerType? TypeOfCollaborator { get; set; }
        /// <summary>
        /// Trạng thái cuộc gọi
        /// </summary>
        [QuerySearch]
        ...
        public FormCollaborator(IHttpContextAccessor httpContext) : base(httpContext)
        {
        }
