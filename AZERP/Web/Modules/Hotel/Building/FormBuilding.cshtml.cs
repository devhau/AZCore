...
namespace AZERP.Web.Modules.Hotel.Building
{
    ...
    public class FormBuilding : ManageModule<BuildingService, BuildingModel, FormUpdateBuilding>
    {
        #region -- Field Search --
        /// <summary>
        /// Họ Tên
        ...
        /// </summary>
        [QuerySearch]
        public string AspirationsOfBuildings { get; set; }
        /// <summary>
        ...
        /// </summary>
        [QuerySearch]
        public PartnerType? TypeOfBuilding { get; set; }
        /// <summary>
        /// Trạng thái cuộc gọi
        /// </summary>
        [QuerySearch]
        ...
        public FormBuilding(IHttpContextAccessor httpContext) : base(httpContext)
        {
        }
        protected override void IntData()
        {
            this.Title = "Khu nhà trọ";
        }
